            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={form.unidade} onValueChange={(val) => setForm((prev) => ({ ...prev, unidade: val ?? "" }))}>
                    <SelectTrigger className="h-[42px]"><SelectValue placeholder="Selecione" /></SelectTrigger>
                    <SelectContent>
