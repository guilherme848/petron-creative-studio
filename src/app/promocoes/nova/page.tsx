...
export default function NovaPromocaoPage() {
  ...
  const removerSelo = () => {
    if (form.seloUrl) URL.revokeObjectURL(form.seloUrl);
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Nova Promoção</h2>
          <p className="text-sm text-muted-foreground mt-1">
            Configure todos os detalhes da promoção e seus produtos.
          </p>
        </div>
      </div>
